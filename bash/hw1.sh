...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'hw11.nizhang.us.kg'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiMWRkNzllMzYtYmNiYi00NTE3LWE3NzUtZDIwYjVhNmQwNTU3IiwicyI6Ik5UWTBaVEJrTWpndFpUSXdOeTAwWXpKakxXRmhaamt0TURjMk5UQTFPRFV3WkdabSJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'60972'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'56350'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'23073'}              # HY2端口必填

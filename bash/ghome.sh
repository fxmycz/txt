...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'ghome.5a5e.cloudns.be'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiNjkzMTg2NzktNmUyMy00MWNhLTkyMTItODY2ODliODk1YTc0IiwicyI6IllqRTJZbVJpTmpNdE9HUmhPUzAwWm1Ga0xXSTBaRFl0TWpsa09HTXdOemd3TVRoayJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'24053'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'42203'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'53941'}              # HY2端口必填

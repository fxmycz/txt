...
export LC_ALL=C
export UUID=${UUID:-'8dc8cbd9-2323-441b-ba14-b64cf1b5e928'}  
export ARGO_DOMAIN=${ARGO_DOMAIN:-'feilong.hw1.cloudns.be'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiMjBiMjViMDlkYzI2M2Q5YjFjZWY1NzlmMDg1MjVmYTQiLCJ0IjoiYTBkYTllYjQtNTIyNy00YjBkLTg1ZGUtMGIzYjY4NzhjMDVkIiwicyI6Ik56QTBORFptTkRVdE9XVmpZeTAwWmpNMUxUZzVOall0TWpSaE9ETmxaVGcwTldJeiJ9'}     
export vless_port=${vless_port:-'55522'}    
export vmess_port=${vmess_port:-'55511'}  
export hy2_port=${hy2_port:-'55566'}       
export IP=${IP:-'188.68.250.202'}                  

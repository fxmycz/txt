...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'hw1.nizhang.us.kg'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiNzVkMmJkOTEtM2JlZC00ZmQ5LTlmN2YtYzE4OTMyMzg3ZGI1IiwicyI6Ik1qazBNRGhoWm1ZdE9HTTFaaTAwTlRVNExXSXlabUV0WkRjME9UUmtNbVE1TmpNNCJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'37241'}       # VMESS端口必填

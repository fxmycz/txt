...
export UUID=${UUID:-'15afdde2-81fd-473e-aa93-4af38663aa3a'}  
export ARGO_DOMAIN=${ARGO_DOMAIN:-'haolai.otc.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiMjBiMjViMDlkYzI2M2Q5YjFjZWY1NzlmMDg1MjVmYTQiLCJ0IjoiYjQ1N2YwMTktYzYwZS00ODQ1LWEzMjctMDI2NTA5OTVjODMxIiwicyI6Ik9EWTNOelV4TXpZdE1EZGxaUzAwWkdVNExUZzBaVFl0TURnd09ETm1OelF3WTJJNSJ9'}     
export vless_port=${vless_port:-'20200'}    
export vmess_port=${vmess_port:-'10100'}  
export hy2_port=${hy2_port:-'30300'}       
export IP=${IP:-'188.68.240.160'}                  

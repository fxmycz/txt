...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'5805911e-e134-41e2-ad2d-9ac862f88888'}
export NEZHA_SERVER=${NEZHA_SERVER:-''} 
export NEZHA_PORT=${NEZHA_PORT:-'5555'}     
export NEZHA_KEY=${NEZHA_KEY:-''} 
export ARGO_DOMAIN=${ARGO_DOMAIN:-'segem.5a5e.cloudns.be'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiMWMwYWE1ZjYtZDhhNy00NGE2LWExNWItMTMyZWUzMWMwMDVmIiwicyI6Ik1qYzRZakExTTJFdE16bGpOUzAwWm1FekxXRmpNekV0TjJGaU5qazRZMkUxWWpNeCJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'60227'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'00001'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'49772'}              # HY2端口必填

...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'lspnb.laoge.nyc.mn'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiYmZjMTNmNTAtNWNkOC00NjU2LTk3ODEtYTMyOTE3OWZjOGJjIiwicyI6IlpEUXdOV05oT0dRdFlUSTFNeTAwTkRNNUxUaGtObUl0TldZek5USmtPRFpqWVdVNSJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'26348'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'00001'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'63929'}              # HY2端口必填

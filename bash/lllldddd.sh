...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'lllldddd.laoge.nyc.mn'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiNTI1MzY0YTItODk2ZS00ZDBiLWExNWMtYmNmZDNhNDJiMTIxIiwicyI6IlpqVmlObVEzTXprdFptVTRZUzAwT0RKaUxUZ3dORE10TWpFeU1UazJNREkyTlRNNCJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'36241'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'10201'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'43143'}              # HY2端口必填

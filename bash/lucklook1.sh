...
export UUID=${UUID:-'aebac872-4263-4e01-9967-ee81daecaca0'}  
export ARGO_DOMAIN=${ARGO_DOMAIN:-'lk.5a5e.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiMjBiMjViMDlkYzI2M2Q5YjFjZWY1NzlmMDg1MjVmYTQiLCJ0IjoiN2FjODA5NjctZTVjNC00Mzc1LWFjNzctZTYwMzAyYzZiNjQ1IiwicyI6Ik9UVTNaV1ZqTnpjdFpEYzVPUzAwWVRabExXRXpZVE10TVdNMU1XVmxNMk01WmpRMyJ9'}     
export vless_port=${vless_port:-'10100'}    
export vmess_port=${vmess_port:-'20200'}  
export hy2_port=${hy2_port:-'30300'}       
export IP=${IP:-'128.204.223.42'}                  

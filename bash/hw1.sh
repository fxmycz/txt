...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'hw11.nizhang.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiMWRkNzllMzYtYmNiYi00NTE3LWE3NzUtZDIwYjVhNmQwNTU3IiwicyI6Ik5UWTBaVEJrTWpndFpUSXdOeTAwWXpKakxXRmhaamt0TURjMk5UQTFPRFV3WkdabSJ9'}
export VMESS_PORT=${VMESS_PORT:-'60972'}
export TUIC_PORT=${TUIC_PORT:-'56350'}
export HY2_PORT=${HY2_PORT:-'23073'}

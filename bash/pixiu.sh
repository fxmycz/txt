...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'pixiu.laoge.nyc.mn'}         # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiY2YxOGViZDg0OTJhOTQ4ZGQ3ZjMyMzMzZmUzMmFlYTQiLCJ0IjoiNmM3ZTUxOTYtYmMxMS00ZmUzLWE1ZWMtNWE1NzNmMWQ3MGI5IiwicyI6Ik5XSmxaRE0yTVRndFpqZzJPQzAwTmpKakxUbG1NRGN0WWpoaU9ESTJZbU14TlROaiJ9'}                    # ARGO 固定隧道token，留空将使用临时隧道
export VMESS_PORT=${VMESS_PORT:-'57143'}       # VMESS端口必填
export TUIC_PORT=${TUIC_PORT:-'42215'}            # TUIC端口必填
export HY2_PORT=${HY2_PORT:-'60304'}              # HY2端口必填

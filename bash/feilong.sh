...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'feilong.54110.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiM2NiNTM1ZGQ4MTAzNTdmMjIxNjZjNzE4MzhlNzM4MmIiLCJ0IjoiOWIwM2MwM2MtMGFhYy00ZDQ5LWIzZGMtMTNkNzRkMmQyMTA5IiwicyI6IllUQXdOR1ptT1dJdFpESTRNaTAwTURJMExUbGhOVGN0TURFM1lXTXlaVFkzWlRjMSJ9'}
export VMESS_PORT=${VMESS_PORT:-'9891'}
export TUIC_PORT=${TUIC_PORT:-'20858'}
export HY2_PORT=${HY2_PORT:-'29385'}
